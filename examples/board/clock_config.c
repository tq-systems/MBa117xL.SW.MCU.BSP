 ...
 *
 * 3. Call CLOCK_SetRootClock() to configure corresponding module clock source
 * and divider.
 *
 */
...
- {id: FLEXSPI1_CLK_ROOT.outFreq, value: 88 MHz}
...
- {id: ANADIG_PLL.SYS_PLL2_PFD1_DIV.scale, value: '16', locked: true}
- {id: ANADIG_PLL.SYS_PLL2_PFD1_MUL.scale, value: '18', locked: true}
- {id: ANADIG_PLL.SYS_PLL2_SS_DIV.scale, value: '268435455'}
- {id: ANADIG_PLL.SYS_PLL3_PFD0_DIV.scale, value: '13', locked: true}
- {id: ANADIG_PLL.SYS_PLL3_PFD0_MUL.scale, value: '18', locked: true}
- {id: ANADIG_PLL.SYS_PLL3_PFD3_DIV.scale, value: '18', locked: true}
...
- {id: CCM.CLOCK_ROOT20.DIV.scale, value: '6', locked: true}
- {id: CCM.CLOCK_ROOT20.MUX.sel, value: ANADIG_PLL.SYS_PLL2_CLK}
- {id: CCM.CLOCK_ROOT24.DIV.scale, value: '1', locked: true}
...
const clock_video_pll_config_t videoPllConfig_BOARD_BootClockRUN = {
  .loopDivider = 41, /* PLL Loop divider, valid range for DIV_SELECT divider
                        value: 27 ~ 54. */
  .postDivider = 0,  /* Divider after PLL, should only be 1, 2, 4, 8, 16, 32 */
  .numerator = 1, /* 30 bit numerator of fractional loop divider, Fout = Fin * (
                     loopDivider + numerator / denominator ) */
  .denominator = 960000, /* 30 bit denominator of fractional loop divider, Fout
...
void BOARD_BootClockRUN(void)
{
  ...
  /* Set DCDC to DCM mode to improve the efficiency for light loading in run
   * mode and transient performance with a big loading step. */
  ...
  if ((ANADIG_LDO_SNVS->PMU_LDO_LPSR_DIG
       & ANADIG_LDO_SNVS_PMU_LDO_LPSR_DIG_BYPASS_MODE_MASK)
      == 0UL)
  {
  ...
  /* Configure FLEXSPI1 using SYS_PLL2_CLK */
