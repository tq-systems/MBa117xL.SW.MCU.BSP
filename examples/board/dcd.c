...
const uint8_t dcd_data[] = {
	...
	/* #1.133, command: write_value, address: SEMC_SDRAMCR1, value: 0x664B22, size: 4, comment: 'ACT2PRE, CKEOFF 42ns / WRC 15ns / RFRC 72ns / ACT2RW, PRE2ACT 18ns' */
	0x40, 0x0D, 0x40, 0x44, 0x00, 0x66, 0x4B, 0x22,
	/* #1.134, command: write_value, address: SEMC_SDRAMCR2, value: 0x10B0B, size: 4, comment: 'ACT2ACT 12ns / REF2REF, SRRC 72ns' */
