...
#define BOARD_BOOTCLOCKRUN_AXI_CLK_ROOT               792000000UL    /* Clock consumers of AXI_CLK_ROOT output : FLEXRAM */
...
#define BOARD_BOOTCLOCKRUN_M7_CLK_ROOT                792000000UL    /* Clock consumers of M7_CLK_ROOT output : ARM */
