...
typedef struct _FlexSPIConfig
{
  ...
  uint8_t columnAddressWidth; //!< [0x00f-0x00f] Column address width, for
  ...
  uint8_t configModeType[3]; //!< [0x01d-0x01f] Configure Mode Type, similar as
                             //!< deviceModeTpe
  flexspi_lut_seq_t
    configCmdSeqs[3]; //!< [0x020-0x02b] Sequence info for Device Configuration
                      //!< command, similar to deviceModeSeq
